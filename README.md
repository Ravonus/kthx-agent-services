...
src/
  ...
  openclaw/                  OpenClaw agent integration (legacy wake receiver kept for compatibility)
...
- `MG_OPENCLAW_BIN` / `OPENCLAW_BIN` (optional) - explicit OpenClaw CLI path or command name override
