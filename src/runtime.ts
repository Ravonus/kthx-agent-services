...
import { startRetentionCleanupLoop } from "./runtime-retention.js";
import {
  markWsActivity,
...
export const startRuntime = async (deps: RuntimeDeps): Promise<void> => {
  ...
  // -- Retention cleanup interval (double retention + optional agent compaction)
  startRetentionCleanupLoop(ctx, intervals);
